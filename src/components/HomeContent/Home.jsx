...
const Home = () => {
    return (
        <div
            className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between mt-24 px-10 py-20"
            style={{
                background: 'linear-gradient(83.09deg, rgb(255, 255, 255) -10%, rgb(240, 242, 255) 80%)'
            }}
        >
            {/* Left Content */}
