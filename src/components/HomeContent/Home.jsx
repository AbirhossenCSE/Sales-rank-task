...
const Home = () => {
    return (
        <div className='bg-white bg-[radial-gradient(100%_50%_at_0%_0%,rgba(59,130,246,0.13)_0,rgba(59,130,246,0)_50%,rgba(59,130,246,0)_100%)]'>
            <div
                className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between  px-10 py-20"
            >
                {/* Left Content */}
                <div className="flex-1 space-y-10 max-w-xl">
                    ...
                    <div className="flex gap-6">
                        ...
                        <div className="flex items-center gap-4 bg-white shadow-lg p-4 rounded-lg">
                            ...
                            <div>
                                <h3 className="text-xl font-semibold">7001+</h3>
                ...
                <div className="relative mt-16 lg:mt-0 flex-1 flex justify-center items-center">
                    ...
                    {/* Floating Box */}
                    <div className="absolute -bottom-16 bg-white shadow-lg rounded-xl p-6 w-[320px]">
                        <div className="flex justify-between mb-4 text-xl font-bold text-blue-700">
                            <span>721+</span>
                            <span>1000+</span>
                        </div>
                        <h3 className="text-lg font-semibold text-gray-800 mb-2">Growth is our priority.</h3>
